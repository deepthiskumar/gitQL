...
-- [(0,[MChc 1 [(1,[MStr "bca"])] []]),(0,[MChc 1 [] [(4,[MStr "ba"])],MStr "a"]),(0,[MChc 1 [(4,[MStr "b"])] [],MStr "aa"])]
...
-- [(0,[MChc 1 [(0,[MStr "aca"])] [(3,[MStr "aba"])]]),(0,[MChc 1 [] [(6,[MStr "a"])],MStr "aa"]),(0,[MChc 1 [(3,[MStr "ab"])] [],MStr "a"])]
-- >>> match ((ch 'a') `Seq` _a) [Chc 1 [Str "ab"] [Str "a"], Str "aaaa"]
-- [(0,[MChc 1 [] [(0,[MStr "a"])],MStr "aa"]),(0,[MChc 1 [(0,[MStr "ab"])] [],MStr "a"])]
-- >>> match ((ch 'a') `Seq` _a) [Chc 1 [Str "acaab"] [Str "lmnabaa"], Str "aaaa"]
-- [(0,[MChc 1 [(0,[MStr "aca"])] [(3,[MStr "aba"])]]),(0,[MChc 1 [] [(6,[MStr "a"])],MStr "aa"]),(0,[MChc 1 [(3,[MStr "ab"])] [],MStr "a"])]
-- >>> match ((ch 'a') `Seq` _a) [Chc 1 [Str "acaab"] [Str "lmabaa"], Str "aaaa"]
-- [(0,[MChc 1 [(0,[MStr "aca"])] []]),(0,[MChc 1 [] [(5,[MStr "a"])],MStr "aa"]),(0,[MChc 1 [(3,[MStr "ab"])] [],MStr "a"])]
--
